...
enum GlobalConfig {
    ...
    static let LOOP_SOURCE_CONFIGURATIONS: [LoopSourceConfiguration] = [
        LoopSourceConfiguration(sourceName: "TR-8S", trackID: 0, boundingBoxX: 0.40, boundingBoxY: 0.12, boundingBoxZ: 0.3, boundingBoxOffsetY: 0.04, boundingBoxOffsetZ: 0.1, viewAttachmentVerticalOffset: 0.2, referenceObjectName: "TR-8S_Scaled"),
        ...
        LoopSourceConfiguration(sourceName: "MS-20", trackID: 4, boundingBoxX: 0.6, boundingBoxY: 0.3, boundingBoxZ: 0.3, boundingBoxOffsetY: 0.23, boundingBoxOffsetZ: 0.15, viewAttachmentVerticalOffset: 0.2, referenceObjectName: "MS-20")
    ]
